...
\item Explain what a Type I error represents in this context.
    2. Explain what a Type II error represents in this context. Which error is more dangerous?
...
\item State $H_0$ and $H_1$.
    2. Compute the test statistic $Z_{\text{calc}}$.
    3. At significance level $\alpha = 0.05$ ($z_{0.05} = 1.645$), do we reject $H_0$?
