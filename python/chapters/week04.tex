...
\begin{intuitionbox}{List Memory References and Shallow Copy Aliasing}
When you assign a list to a new variable (\texttt{b = a}), Python creates an \textbf{alias} referencing the exact same object in memory! Modifying \texttt{b} will unexpectedly modify \texttt{a}:
\begin{lstlisting}[style=pystyle]
a = [1, 2, 3]
b = a          # Reference copy (aliasing)
b[0] = 999     # Modifies both b AND a!

# To create a independent copy, use slicing or copy():
