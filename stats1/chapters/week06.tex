...
\begin{figure}[htpb]
    ...
    \begin{minipage}{0.3\textwidth}
        \centering
        \begin{venndiagram2sets}[radius=1.2cm, labelA=$A$, labelB=$B$]
            \fillA \fillB
...
\begin{intuitionbox}{Probability as a Mass}
To intuitively understand Kolmogorov's Axioms, think of probability as \textbf{physical mass}. You are handed exactly 1.0 kg of modeling clay (the total probability, Axiom 2). You must distribute this clay across all the possible outcomes in your sample space. 

You can give an outcome zero clay, or some positive amount, but you cannot give an outcome "negative" clay (Axiom 1). If you want to know the weight of a combined event (like "rolling an even number"), you simply put the 2-outcome, 4-outcome, and 6-outcome on a scale and add their weights together (Axiom 3).
\end{intuitionbox}
