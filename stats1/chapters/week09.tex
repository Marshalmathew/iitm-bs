...
\begin{enumerate}
    \item \textbf{Calculating Expectation:} A lottery ticket costs ₹10 to play. You have a $1\%$ chance of winning ₹500, a $5\%$ chance of winning ₹50, and a $94\%$ chance of winning nothing (₹0). Let $X$ be the gross payout of the ticket.
    \begin{enumerate}
        \item What is the PMF of $X$?
        \item Calculate the Expected Value $E[X]$.
        \item Factoring in the ₹10 cost to play, what is your expected net profit?
    \end{enumerate}
