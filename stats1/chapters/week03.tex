...
\begin{enumerate}
    \item \textbf{Central Tendency:} A startup has 5 employees. Four engineers make ₹80,000 each. The CEO makes ₹1,680,000. 
    \begin{enumerate}
        \item Calculate the Mean salary and the Median salary.
        \item The CEO goes to the press and says, "Our average employee makes ₹400,000! We pay great!" Explain mathematically why this is highly misleading, and state whether the distribution is Left-Skewed or Right-Skewed.
    \end{enumerate}
