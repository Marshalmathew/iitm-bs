...
\begin{intuitionbox}{3D Surface Loss Bowl and Contour Map}
Below is a 3D visualization of a convex loss surface $z = f(x,y) = x^2 + y^2$ alongside its 2D concentric circular contour map.
\begin{center}
\begin{tikzpicture}
\begin{axis}[
...
\addplot3[surf, domain=-2:2, domain y=-2:2, samples=20] {x^2 + y^2};
\end{axis}
\end{tikzpicture}
\end{center}
\end{intuitionbox}
